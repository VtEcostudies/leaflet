...
function initXhrRequest(url) {
    ...
    //load the first N records of data, which initiates subsequent page * N loads
    loadPage(url, 0);
}
...
function loadPage(url, startIndex) {
     ...
     * In our case, we told the server to send us JSON.  Here, the reponse is text and we have to JSON.parse(response).
     */
